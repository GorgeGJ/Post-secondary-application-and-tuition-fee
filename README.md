...
Eq (1):
log(Tuition3) = α0 +α1log(Applcn)+α2log(Stufacr)+α3public+α4Locale+α5tier

Eq (2):
log(Applcn) = λ0 +λ1log(Tuition3)+λ2log(Stufacr)+λ3log(k mean)+λ4Locale+λ5tier

Eq(1) is supply equation and Eq(2) is demand equation.
